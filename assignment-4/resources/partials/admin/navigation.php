...
<nav class="border-b border-opacity-25 border-sky-300 bg-sky-600" x-data="{ mobileMenuOpen: false, userMenuOpen: false }">
            ...
            <div class="flex items-center px-2 lg:px-0">
                <div class="hidden sm:block">
                    <div class="flex space-x-4">
                        ...
                        <a href="/admin" class="px-3 py-2 text-sm font-medium rounded-md <?= admin_active_menu_styles("/admin") ?>">Customers</a>
                        <a href="/admin/transactions" class="px-3 py-2 text-sm font-medium rounded-md <?= admin_active_menu_styles("/admin/transactions") ?>">Transactions</a>
                    </div>
                </div>
            </div>
    ...
    <div x-show="mobileMenuOpen" class="sm:hidden" id="mobile-menu">
        <div class="pt-2 pb-3 space-y-1">
            <a href="/admin" class="block px-3 py-2 text-base font-medium text-white rounded-md hover:bg-sky-500 hover:bg-opacity-75">Customers</a>
