...
<nav class="border-b border-emerald-300 border-opacity-25 bg-emerald-600" x-data="{ mobileMenuOpen: false, userMenuOpen: false }">
            ...
            <div class="flex items-center px-2 lg:px-0">
                <div class="hidden sm:block">
                    <div class="flex space-x-4">
                        ...
                        <a href="/dashboard" class="<?= dashboard_active_menu_styles("/dashboard") ?> rounded-md py-2 px-3 text-sm font-medium" aria-current="page">Dashboard</a>
                        <a href="/dashboard/deposit" class="<?= dashboard_active_menu_styles("/dashboard/deposit") ?> rounded-md py-2 px-3 text-sm font-medium">Deposit</a>
                        <a href="/dashboard/withdraw" class="<?= dashboard_active_menu_styles("/dashboard/withdraw") ?> rounded-md py-2 px-3 text-sm font-medium">Withdraw</a>
                        <a href="/dashboard/transfer" class="<?= dashboard_active_menu_styles("/dashboard/transfer") ?> rounded-md py-2 px-3 text-sm font-medium">Transfer</a>
                    </div>
                </div>
            </div>
                        ...
                        alt="Ahmed Shamim Hasan Shaon" /> -->
                            <span class="inline-flex h-10 w-10 items-center justify-center rounded-full bg-emerald-100">
                                <span class="font-medium leading-none text-emerald-700">
                                    <?= get_acronym_word(Session::get("auth_username")) ?>
                                </span>
                            </span>
                        </button>
                    </div>
    ...
    <div x-show="mobileMenuOpen" class="sm:hidden" id="mobile-menu">
        <div class="space-y-1 pt-2 pb-3">
            <a href="/dashboard" class="<?= dashboard_active_menu_styles("/dashboard") ?> block rounded-md py-2 px-3 text-base font-medium" aria-current="page">Dashboard</a>

            <a href="/dashboard/deposit" class="<?= dashboard_active_menu_styles("/dashboard/deposit") ?> block rounded-md py-2 px-3 text-base font-medium">Deposit</a>

            <a href="/dashboard/withdraw" class="<?= dashboard_active_menu_styles("/dashboard/withdraw") ?> block rounded-md py-2 px-3 text-base font-medium">Withdraw</a>

            <a href="/dashboard/transfer" class="<?= dashboard_active_menu_styles("/dashboard/transfer") ?> block rounded-md py-2 px-3 text-base font-medium">Transfer</a>
        </div>
            ...
            <div class="flex items-center px-5">
                ...
                <div class="ml-3">
                    <div class="text-base font-medium text-white">
                        <?= ucwords(Session::get("auth_username")) ?? "Guest" ?>
                    </div>
                    <div class="text-sm font-medium text-emerald-300">
                        <?= Session::get("auth_useremail") ?? "guest@test.com" ?>
                    </div>
                </div>
