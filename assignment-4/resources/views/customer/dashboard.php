...
<body class="h-full">
  <div class="min-h-full">
    <div class="bg-emerald-600 pb-32">
      <!-- Navigation -->
      <?php include_once __DIR__ . "/../../partials/customer/navigation.php" ?>

      <header class="py-10">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h1 class="text-3xl font-bold tracking-tight text-white">
            Howdy, <?= ucwords($_SESSION["auth_username"]) ?? "Guest" ?> 👋
          </h1>
        </div>
      </header>
    </div>
              ...
              <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                  ...
                  <?php
                    ...
                    <div class="py-5">
                      <h1 class="text-red-600">Sorry currently you don't have any transaction!</h1>
                      <p class="mt-2 text-sm text-gray-500">
                        Visit <a href="/dashboard/deposit" class="font-semibold leading-6 text-emerald-600 hover:text-emerald-500">Here</a> to create a new transaction.
                      </p>
